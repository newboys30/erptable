package com.bioFish.ERPTables.Config;
...
import com.bioFish.ERPTables.util.SpringContextUtil;
...
public class MybatisConfiguration {
	...
	public SqlSessionFactory sqlSessionFactory() throws Exception{
		 try {
			...
			//实体类
			sessionFactoryBean.setTypeAliasesPackage("com.bioFish.ERPTables.Entity");
			//mapper位置
